...
- [ ] **Scenarios — war-story gauntlet**: six ticket-style production problems
      with measured before/after (slow import, dropped work on deploys,
      upstream 429s, double-applied payment, tiny-write flood, goroutine
      leak) — system defined in [`../BACKEND-MASTERY.md`](../BACKEND-MASTERY.md),
      bullets land in [`../WAR-STORIES.md`](../WAR-STORIES.md)
